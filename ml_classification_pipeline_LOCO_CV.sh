...
# Scripts paths
infile_partition="$HOMEC/Scripts/infile_partition_LOCO.R"
...
# Input data
infile="$HOMEC/Test_data/in_phylo_LOCO_CV.rds"
...
LO_Cohort="cohort_1"          # Hold-out set cohort
...
Rscript --vanilla "$infile_partition" "$infile" "$Variable" "$LO_Cohort"
